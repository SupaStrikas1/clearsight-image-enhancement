...
def reorganize_lol(base_dir, input_sub='low', target_sub='high', split_ratios=(0.8, 0.1, 0.1)):
    """
    Reorganizes LOL dataset from low/high to train/val/test with rain/norain subfolders.
    Args:
        base_dir: Path to lol folder (e.g., 'data/lol')
        input_sub: Subfolder with low-light images (default: 'low')
        target_sub: Subfolder with GT images (default: 'high')
