...
def reorganize_rain100h(base_dir, input_sub='data', target_sub='gt', split_ratios=(0.8, 0.1, 0.1)):
    """
    Reorganizes Rain100H dataset from data/gt to train/val/test with rain/norain subfolders.
    Args:
        base_dir: Path to rain100h folder (e.g., 'data/rain100h')
        input_sub: Subfolder with rainy images (default: 'data')
...
if __name__ == '__main__':
    base_dir = 'data/rain100h'
    reorganize_rain100h(base_dir)